using CreditCalculator.OwnSolution;
using FluentAssertions;

namespace CreditCalculator.Tests;

public class CustomerServiceOwnSolutionTests
{
    ...
    {
        // Arrange
        var customerService = new CustomerService(new CompanyRepository(), new CustomerCreditServiceClient(), new CustomerRepository());
